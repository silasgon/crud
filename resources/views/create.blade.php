...
@section('content')
    ...
    <div class="col-8 m-auto">
      ...
      @endif
        ...
        <input class="form-control" type="text" name="pages" id="title" placeholder="Páginas:" value="{{ $book->pages ?? ''}}" required><br>
        <input class="form-control" type="text" name="price" id="title" placeholder="Preço:" value="{{ $book->price ?? ''}}" required><br>
